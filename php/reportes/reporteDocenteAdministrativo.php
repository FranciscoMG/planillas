...
<?php $resultadoDocente = $db->obtenerDocenteAdministrativo(); ?>
<?php $resultadoDocente2 = $db->obtenerDocenteAdministrativo(); ?>
...
$pdf->Cell(10,10,"Reporte de Docentes Administrativos");
$pdf->Ln();
...
while ($fila = mysqli_fetch_assoc($resultadoDocente)) {
	...
	///////// cantidad de jornada ////
	$jornadaAsignada = $fila['jornada_docenteAdministrativo'];
