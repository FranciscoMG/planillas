        ...
        <div class="modal-body">
          ...
          <div id="seccionEliminarDocente2">
            <div id="docenteAgregar2" class="col-xs-12 col-sm-12 col-lg-12 hide">
              <input type="text" class="form-control input-border" name="txtCedula2" placeholder="Cédula" <?php
            ...
            <div class="form-group col-xs-12 col-sm-12 col-lg-12">
              ...
              <input type="text" class="form-control input-border" name="txtNombre2" placeholder="Nombre" <?php
              if (isset($_GET['modalDocentesConPermisos'])) {
            ...
            <div class="form-group col-xs-12 col-sm-12 col-lg-12">
              ...
              <input type="text" class="form-control input-border" name="txtApellidos2" placeholder="Apellidos" <?php
              if (isset($_GET['modalDocentesConPermisos'])) {
