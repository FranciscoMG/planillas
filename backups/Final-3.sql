...
--
-- Table structure for table `tb_DocenteAdministrativo`
--

DROP TABLE IF EXISTS `tb_DocenteAdministrativo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_DocenteAdministrativo` (
  `cedula` varchar(25) NOT NULL,
  `nombre` varchar(20) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `apellidos` varchar(40) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `grado_academico` int(11) NOT NULL,
  ...
  CONSTRAINT `tb_DocenteAdministrativo_ibfk_1` FOREIGN KEY (`fk_presupuesto`) REFERENCES `tb_Presupuesto` (`id_presupuesto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_DocenteAdministrativo`
--

LOCK TABLES `tb_DocenteAdministrativo` WRITE;
/*!40000 ALTER TABLE `tb_DocenteAdministrativo` DISABLE KEYS */;
INSERT INTO `tb_DocenteAdministrativo` VALUES ('1','1','1',1,1,1,1);
/*!40000 ALTER TABLE `tb_DocenteAdministrativo` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_Log` VALUES (1449724221,2015,12,9,23,10,21,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/53','admi','202cb962ac59075b964b07152d234b70','Usuario','Apellido');
...
INSERT INTO `tb_Mensaje` VALUES (17,'Michael RodrÃ­guez Delgado ','usuario-docencia','Saludos del administrador.','2015-12-08 09:21:26');
...
INSERT INTO `tb_PlanEstudios` VALUES ('1','1');
...
INSERT INTO `tb_Usuario` VALUES ('admi','202cb962ac59075b964b07152d234b70','Usuario','Apellido',0,'-',1),('admin','1db095afdcca96ed2ca147862ca948fe','Administrador','del SIstema',0,'-',1),('usuario-1','202cb962ac59075b964b07152d234b70','Francisco','Melendez',0,'ada@sda.com',1),('usuario-docencia','202cb962ac59075b964b07152d234b70','Gerardo','Chinchilla',1,'ejemplo@1.com',1),('usuario-recursos-h','202cb962ac59075b964b07152d234b70','Ana','Yansy',2,'ejemplo@3.com',1),('vinird','202cb962ac59075b964b07152d234b70','Michael','RodrÃ­guez Delgado ',0,'mvrd_17@hotmail.com',1);
...
-- Dump completed on 2015-12-09 23:10:40
